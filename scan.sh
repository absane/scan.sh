...
nmap -e $INTERFACE --randomize-hosts -iL $HOME/$NETWORK -v -T4 --open -Pn -n -sS -sV -oA $SCAN_RESULTS_LOCATION/$NETWORK --source-port=80 --script=default,safe --top-ports=2000
